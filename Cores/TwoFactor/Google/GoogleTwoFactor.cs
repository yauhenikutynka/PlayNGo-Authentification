...
{
    /// <summary>
    /// Google Two Factor Helper Class
    /// </summary>
    public class GoogleTwoFactor: iTwoFactor
    {
        ...
        public GoogleTwoFactor() : this(true, true) {}

        public GoogleTwoFactor(bool useManagedSha1, bool useUnmanagedOnFail)
        {
        ...
        public SetupCode GenerateSetupCode(string issuer, string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight, bool useHttps)
        {
            ...
            string url = String.Format("{0}://chart.googleapis.com/chart?cht=qr&chs={1}x{2}&chl={3}&choe=UTF-8", protocol, qrCodeWidth, qrCodeHeight, provisionUrl);
        ...
        {
            return ValidateTwoFactorPIN(AccountSecretKey, PinCode);
        }
    }
}
